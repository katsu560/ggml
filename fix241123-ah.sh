...
do_cp CMakeLists.txt	CMakeLists.txt.241123	CMakeLists.txt.241123mod
do_cp src/CMakeLists.txt	src/CMakeLists.txt.241123	src/CMakeLists.txt.241123mod
do_cp src/ggml.c	src/ggml.c.241123	src/ggml.c.241123mod
do_cp src/ggml-alloc.c	src/ggml-alloc.c.241123	src/ggml-alloc.c.241123mod
do_cp src/ggml-backend-impl.h	src/ggml-backend-impl.h.241123	src/ggml-backend-impl.h.241123mod
do_cp src/ggml-impl.h	src/ggml-impl.h.241123	src/ggml-impl.h.241123mod
do_cp src/ggml-quants.h	src/ggml-quants.h.241123	src/ggml-quants.h.241123mod
do_cp src/ggml-quants.c	src/ggml-quants.c.241123	src/ggml-quants.c.241123mod
#do_cp src/ggml-opencl.c	src/ggml-opencl.c.230521	src/ggml-opencl.c.240121mod
do_cp tests/CMakeLists.txt	tests/CMakeLists.txt.241123	tests/CMakeLists.txt.241123mod
do_cp tests/test-blas0.c	tests/test-blas0.c.241123	tests/test-blas0.c.241123mod
# do_cp tests/test-grad0.c	tests/test-grad0.c.230730	tests/test-grad0.c.230811mod
do_cp tests/test-mul-mat0.c	tests/test-mul-mat0.c.241123	tests/test-mul-mat0.c.241123mod
do_cp tests/test-mul-mat1.c	tests/test-mul-mat1.c.240120	tests/test-mul-mat1.c.241123mod
do_cp tests/test-mul-mat2.c	tests/test-mul-mat2.c.240120	tests/test-mul-mat2.c.241123mod
# do_cp tests/test-opt.c	tests/test-opt.c.230730	tests/test-opt.c.230811mod
do_cp tests/test-opt.cpp	tests/test-opt.cpp.241123	tests/test-opt.cpp.241123mod
do_cp tests/test-pool.c	tests/test-pool.c.241123	tests/test-pool.c.241123mod
do_cp tests/test-quantize-fns.cpp	tests/test-quantize-fns.cpp.241123	tests/test-quantize-fns.cpp.241123mod
do_cp tests/test-quantize-perf.cpp	tests/test-quantize-perf.cpp.241123	tests/test-quantize-perf.cpp.241123mod
do_cp tests/test-vec1.c	tests/test-vec1.c.240120	tests/test-vec1.c.241123mod
do_cp tests/test-vec2.c	tests/test-vec2.c.240120	tests/test-vec2.c.241123mod
do_cp tests/test0.c	tests/test0.c.241123	tests/test0.c.241123mod
...
do_cp examples/CMakeLists.txt	examples/CMakeLists.txt.241123	examples/CMakeLists.txt.241123mod
do_cp examples/common.cpp	examples/common.cpp.241123	examples/common.cpp.241123mod
do_cp examples/common.h	examples/common.h.241123	examples/common.h.241123mod
do_cp examples/common-ggml.cpp	examples/common-ggml.cpp.241123	examples/common-ggml.cpp.241123mod
do_cp examples/common-ggml.h	examples/common-ggml.h.240120	examples/common-ggml.h.241123mod
do_cp examples/gpt-j/CMakeLists.txt	examples/gpt-j/CMakeLists.txt.240120	examples/gpt-j/CMakeLists.txt.241123mod
do_cp examples/gpt-j/main.cpp	examples/gpt-j/main.cpp.241123	examples/gpt-j/main.cpp.241123mod
do_cp examples/gpt-j/quantize.cpp	examples/gpt-j/quantize.cpp.241123	examples/gpt-j/quantize.cpp.241123mod
do_cp examples/gpt-2/CMakeLists.txt	examples/gpt-2/CMakeLists.txt.241123	examples/gpt-2/CMakeLists.txt.241123mod
do_cp examples/gpt-2/main-alloc.cpp	examples/gpt-2/main-alloc.cpp.241123	examples/gpt-2/main-alloc.cpp.241123mod
do_cp examples/gpt-2/main-ctx.cpp	examples/gpt-2/main-ctx.cpp.241123	examples/gpt-2/main-ctx.cpp.241123mod
do_cp examples/gpt-2/main-backend.cpp	examples/gpt-2/main-backend.cpp.241123	examples/gpt-2/main-backend.cpp.241123mod
do_cp examples/gpt-2/main-batched.cpp	examples/gpt-2/main-batched.cpp.241123	examples/gpt-2/main-batched.cpp.241123mod
do_cp examples/gpt-2/quantize.cpp	examples/gpt-2/quantize.cpp.241123	examples/gpt-2/quantize.cpp.241123mod
msg "RESULT: $RESULT"
