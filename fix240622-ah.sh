...
do_cp CMakeLists.txt	CMakeLists.txt.240618	CMakeLists.txt.240622mod
do_cp src/CMakeLists.txt	src/CMakeLists.txt.240618	src/CMakeLists.txt.240622mod
do_cp src/ggml.c	src/ggml.c.240622	src/ggml.c.240622mod
do_cp src/ggml-alloc.c	src/ggml-alloc.c.240618	src/ggml-alloc.c.240622mod
do_cp src/ggml-backend-impl.h	src/ggml-backend-impl.h.240618	src/ggml-backend-impl.h.240622mod
do_cp src/ggml-backend.c	src/ggml-backend.c.240618	src/ggml-backend.c.240622mod
do_cp src/ggml-impl.h	src/ggml-impl.h.240618	src/ggml-impl.h.240622mod
do_cp src/ggml-quants.h	src/ggml-quants.h.240504	src/ggml-quants.h.240622mod
do_cp src/ggml-quants.c	src/ggml-quants.c.240618	src/ggml-quants.c.240622mod
do_cp include/ggml/ggml.h	include/ggml/ggml.h.240622	include/ggml/ggml.h.240622mod
#do_cp src/ggml-opencl.c	src/ggml-opencl.c.230521	src/ggml-opencl.c.240121mod
do_cp tests/CMakeLists.txt	tests/CMakeLists.txt.240618	tests/CMakeLists.txt.240622mod
do_cp tests/test-blas0.c	tests/test-blas0.c.240120	tests/test-blas0.c.240622mod
# do_cp tests/test-grad0.c	tests/test-grad0.c.230730	tests/test-grad0.c.230811mod
do_cp tests/test-grad0.cpp	tests/test-grad0.cpp.240618	tests/test-grad0.cpp.240622mod
do_cp tests/test-mul-mat0.c	tests/test-mul-mat0.c.240120	tests/test-mul-mat0.c.240622mod
do_cp tests/test-mul-mat1.c	tests/test-mul-mat1.c.240120	tests/test-mul-mat1.c.240622mod
do_cp tests/test-mul-mat2.c	tests/test-mul-mat2.c.240120	tests/test-mul-mat2.c.240622mod
# do_cp tests/test-opt.c	tests/test-opt.c.230730	tests/test-opt.c.230811mod
do_cp tests/test-opt.cpp	tests/test-opt.cpp.240413	tests/test-opt.cpp.240622mod
do_cp tests/test-pool.c	tests/test-pool.c.240120	tests/test-pool.c.240622mod
do_cp tests/test-quantize-fns.cpp	tests/test-quantize-fns.cpp.240413	tests/test-quantize-fns.cpp.240622mod
do_cp tests/test-quantize-perf.cpp	tests/test-quantize-perf.cpp.240407	tests/test-quantize-perf.cpp.240622mod
do_cp tests/test-vec1.c	tests/test-vec1.c.240120	tests/test-vec1.c.240622mod
do_cp tests/test-vec2.c	tests/test-vec2.c.240120	tests/test-vec2.c.240622mod
do_cp tests/test0.c	tests/test0.c.240120	tests/test0.c.240622mod
do_cp tests/test1.c	tests/test1.c.240120	tests/test1.c.240622mod
do_cp tests/test2.c	tests/test2.c.240413	tests/test2.c.240622mod
do_cp tests/test3.c	tests/test3.c.240413	tests/test3.c.240622mod
...
do_cp examples/CMakeLists.txt	examples/CMakeLists.txt.240618	examples/CMakeLists.txt.240622mod
do_cp examples/common.cpp	examples/common.cpp.240618	examples/common.cpp.240622mod
do_cp examples/common.h	examples/common.h.240618	examples/common.h.240622mod
do_cp examples/common-ggml.cpp	examples/common-ggml.cpp.240525	examples/common-ggml.cpp.240622mod
do_cp examples/common-ggml.h	examples/common-ggml.h.240120	examples/common-ggml.h.240622mod
do_cp examples/gpt-j/CMakeLists.txt	examples/gpt-j/CMakeLists.txt.240120	examples/gpt-j/CMakeLists.txt.240622mod
do_cp examples/gpt-j/main.cpp	examples/gpt-j/main.cpp.240618	examples/gpt-j/main.cpp.240622mod
do_cp examples/gpt-j/quantize.cpp	examples/gpt-j/quantize.cpp.240120	examples/gpt-j/quantize.cpp.240622mod
do_cp examples/gpt-2/CMakeLists.txt	examples/gpt-2/CMakeLists.txt.240618	examples/gpt-2/CMakeLists.txt.240622mod
do_cp examples/gpt-2/main-alloc.cpp	examples/gpt-2/main-alloc.cpp.240407	examples/gpt-2/main-alloc.cpp.240622mod
do_cp examples/gpt-2/main-ctx.cpp	examples/gpt-2/main-ctx.cpp.240407	examples/gpt-2/main-ctx.cpp.240622mod
do_cp examples/gpt-2/main-backend.cpp	examples/gpt-2/main-backend.cpp.240413	examples/gpt-2/main-backend.cpp.240622mod
do_cp examples/gpt-2/main-batched.cpp	examples/gpt-2/main-batched.cpp.240413	examples/gpt-2/main-batched.cpp.240622mod
do_cp examples/gpt-2/quantize.cpp	examples/gpt-2/quantize.cpp.240120	examples/gpt-2/quantize.cpp.240622mod
msg "RESULT: $RESULT"
